...
def sfc_all_pages_per_letter(driver, page_no, item_lim):
	...
	for row in range(2, num_objects+2):
		...
		field2 = driver.find_element_by_xpath(table1 + str(row) + table2 + str(2) + table3 + '/a').get_attribute("innerHTML")
		field3 = driver.find_element_by_xpath(table1 + str(row) + table2 + str(3) + table3).get_attribute("innerHTML")
		field4 = driver.find_element_by_xpath(table1 + str(row) + table2 + str(6) + table3).get_attribute("innerHTML")
